...
export default function AvatarSetting({
  ...
  useEffect(() => {
    setAvatarUrl(appSettings?.noletAvatarUrl || "https://s3.wzs.app/logo.png");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : "settings.avatar.save_failed";
  ...
  return (
    <>
      ...
      <Dialog
        ...
        keepMounted
      >
        <DialogTitle>{t("settings.avatar.dialog_title")}</DialogTitle>
        <DialogContent dividers>
          <Stack spacing={2}>
            ...
            <TextField
              ...
              size="small"
              variant="outlined"
              placeholder="https://s3.wzs.app/logo.png"
              error={!!error}
              helperText={error}
                ...
                {testing ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Stack
                          sx={{ p: 1, display: avatarUrl ? "block" : "none" }}
                        >
                          {!isImageLoaded ? (
                            <Skeleton
                              variant="circular"
                        ...
                        {avatarUrl.length === 0 ? (
                          <Stack sx={{ p: 1 }}>
                            <img
                              src="https://wiki.wzs.app/_media/logo.png"
                              alt="Icon"
                              style={{
                                width: "2.625rem",
                                height: "2.625rem",
